  ...
  return(
    ...
    <div className="header">
      <div className="header__container">
        ...
        <div className={`header__burger-menu ${burgerMenuOpen ? 'open' : ''}`} onClick={toggleBurgerMenu}>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path d="M3 12H21" stroke="#46A358" strokeWidth="2" strokeLinecap="round" />
            <path d="M3 6H21" stroke="#46A358" strokeWidth="2" strokeLinecap="round" />
            <path d="M3 18H21" stroke="#46A358" strokeWidth="2" strokeLinecap="round" />
          </svg>
        </div>
        <div className={`header__menu ${burgerMenuOpen ? 'open' : ''}`}>
